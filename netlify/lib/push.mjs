 ...
 * إشعار الجوّال.
 *
 * التنبيه كان لا يُرى إلا إذا فتح القائدُ التطبيق، فيُكتب المساء ويُقرأ بعد
 ...
 * جهازٌ يُسجَّل.
 *
 * وللقائد الواحد أجهزة — جوّالٌ وآيباد — فتُحفظ كلها، ويُميَّز الجهاز
...
/** هل فعّل هذا القائد إشعاراته؟ يُقرأ في لوحة المدير. */
