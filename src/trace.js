 ...
 *
 * الغرض منه التفويض لا المحاسبة. لما تعطي قائدًا صلاحية وتشوف بعدها رقمًا
 ...
 * ساعةُ الحائط: «٩:٤٦».
 *
 * و«قبل قليل» لا تصلح هنا: من ضغط زرًّا مرتين في دقيقةٍ يقرأ الجوابَ نفسه
 * فيظنّ الزرّ ميتًا. والساعةُ تتغيّر فيُرى أن الضغطة وقعت.
 *
 * والأرقام لاتينية كبقيّة أرقام التطبيق، والساعةُ اثنتا عشرة بلا «ص/م»:
 * يعرفها صاحبُها من يومه، وما يُضاف حرفٌ لا يُقرأ.
 */
