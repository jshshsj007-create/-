 ...
 *
 * كان الاسم الأول وحده هو الفيصل، فاندمج بها من ليس أخاه: «محمد قاسم»
 * و«محمد خالد» تحت ولي أمرٍ واحد يشتركان في الاسم الأول فقط، ودُمِجا رغم
 * أنهما ولدان مختلفان. فصار الفيصل الاسمَ كاملًا — كل كلماته بترتيبها، بعد
 * توحيد الهمزات والتاء المربوطة وإسقاط «بن/ابن» و«ال» التعريف كما تفعل
 * `nameTokens` دائمًا. ومن كتب اسم ابنه ناقصًا مرةً وكاملًا مرة أخرى ينزل
 * طالبين — وهذا أسلم من دمجٍ يخلط بين إخوة.
 */
