 ...
 *
 * وثلاثةٌ حدٌّ لا يُتجاوز: لو فُتح على موظفٍ موسمٌ كامل لم يكتبه، يئس فلم
...
export const noteOn = (studentId, text, by, { programId, weekId, at, studentName, byName } = {}) => ({
   ...
   * يراها الموظفون كلُّهم — فلو استخرجناه من القاعدة لرآها بعضُهم بلا أسماء.
   */
...
export const daySummary = ({ comps = 0, qiyami = [], noteNames: notes = [], roll = null } = {},
  ...
  if (roll) out.push(`تقارير الموظفين: ${rollText(roll)}`);
  return out;
};
